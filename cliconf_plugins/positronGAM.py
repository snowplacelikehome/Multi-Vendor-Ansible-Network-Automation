#
# This is derived from ciscosmb.py
# 
...
cliconf: positronGAM
short_description: Use positronGAM cliconf to run command on Positron GAM network devices
description:
  - This positronGAM plugin provides low level abstraction apis for
    sending and receiving CLI commands from Positron GAM network devices.
'''
...
class Cliconf(CliconfBase):
    ...
    def get_device_info(self):
        ...
        device_info['network_os'] = 'positronGAM'
        ...
        match = re.search(r'^System\s+: (.*)', data, re.M)
        if match:
